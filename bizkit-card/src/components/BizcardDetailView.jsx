...
const BizCardDetailView = () => {
  ...
  return (
    <div className="flex justify-center w-full items-center min-h-screen bg-[#08353B] p-4">
      <div className="bg-[#111314] rounded-lg shadow-lg p-6 w-full max-w-md">
        {bizCard.logo && (
          <div className="flex justify-center mb-4">
            <div className="rounded-full w-24 h-24 sm:w-28 sm:h-28 overflow-hidden border border-gray-700">
              <img
        ...
        <h1 className="text-xl sm:text-2xl font-bold mb-2 text-center text-[#09AD8A]">
          {bizCard.name || 'N/A'}
        </h1>
